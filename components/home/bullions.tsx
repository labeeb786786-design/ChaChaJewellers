      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <Link
              href="/bullions"
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-gold px-5 py-2.5 text-sm font-semibold text-charcoal transition-colors hover:bg-gold-soft"
            >
          ...
          <div className="rounded-2xl border border-gold/25 bg-charcoal-soft p-6">
            <Link
              href="/bullions"
            ...
            >
              ...
              />
              <span className="absolute bottom-2 left-2 rounded-full bg-charcoal/85 px-2.5 py-1 text-xs font-semibold text-gold backdrop-blur">
                50g · 999.9 fine
              </span>
            </Link>
            ...
            <p className="mt-1 font-serif text-3xl font-bold text-gold">
              {formatGBP(spot)}
              <span className="ml-1 text-base font-normal text-cream/50">
                /g (24k)
              </span>
            </p>
